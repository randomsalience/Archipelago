...
base_location_data = [
    ...
    LocationData("Vann's Point", "Music Box", 228,
                 lambda state, player: state.has_all({"Harmonica", "Climbing Gear"}, player)),
    ...
    LocationData("Vann's Point", "Near Smithy Heart Ore", 148,
                 lambda state, player: state.has("Progressive Pick", player) and
                 (state.has("Lariat", player) or (state.has("Weapon Chain", player) and state.prodigal_skips(player)))),
    ...
    LocationData("Vann's Point", "Near Magma Heart Heart Ore", 144,
                 ...
                 (state.has("Climbing Gear", player) or state.has_all({"Lariat", "Progressive Knuckle"}, player))),
    ...
    LocationData("Vann's Point", "Grant Stealth Mission", 203,
                 lambda state, player: state.has_all({"Cursed Bones", "Cursed Pick"}, player)),
    ...
    LocationData("Vann's Point", "Light Spirit", 237,
                 ...
                 state.has_all({"Progressive Knuckle", "Lariat"}, player) and
    ...
    LocationData("Colorless Void", "Colorless Void - Near Tavern Heart Ore", 167,
                 lambda state, player: state.has_all({"Progressive Pick", "Lariat"}, player)),
    ...
    LocationData("Waterfall Cave", "Waterfall Cave - Item", 135,
                 lambda state, player: state.has_all({"Progressive Pick", "Lariat"}, player) or
    ...
    LocationData("Tidal Mines", "Tidal Mines - Barrel Puzzle Heart Ore", 151,
                 lambda state, player: state.prodigal_can_enter_tidal_mines(player) and
    ...
    LocationData("Tidal Mines", "Tidal Mines - Rocks Chest", 13,
                 lambda state, player: state.prodigal_can_enter_tidal_mines(player) and state.prodigal_can_hit(player)),
    ...
    LocationData("Crocasino", "Crocasino - Heart Ore", 161,
                 lambda state, player: state.has_all({"Lariat", "Progressive Knuckle", "Progressive Pick"}, player) and
                 state.prodigal_has_key("Crocasino", player, 2)),
    LocationData("Crocasino", "Crocasino - Wren", 62,
                 lambda state, player: state.has_all({"Lariat", "Progressive Knuckle", "Bunny Key"}, player) and
                 state.prodigal_has_key("Crocasino", player, 2)),
    ...
    LocationData("Castle Vann", "Castle Vann - Main - Left Chest", 31,
                 lambda state, player: state.has("Lariat", player) and (state.prodigal_skips(player) or
                 (state.prodigal_can_hit(player) and state.prodigal_has_key("Castle Vann", player, 4)))),
    ...
    LocationData("Time Out", "Time Out - West - Pits Heart Ore", 150,
                 lambda state, player: state.prodigal_time_out_1_open(player) and
                 state.has_all({"Progressive Pick", "Lariat", "Progressive Knuckle"}, player)),
    ...
    LocationData("Time Out", "Time Out - West - Invisible Item", 123,
                 lambda state, player: state.prodigal_time_out_1_open(player) and
                 state.has_all({"Progressive Pick", "Lariat"}, player) and
    ...
    LocationData("Crystal Caves", "Crystal Caves - West - Barrel Bridge Chest", 118,
                 lambda state, player: state.has("Progressive Knuckle", player, 2) and
                 state.has("Progressive Pick", player) and (state.has("Lariat", player) or
                 state.prodigal_has_cleats(player) or state.prodigal_skips(player))),
    ...
    LocationData("Crystal Caves", "Crystal Caves - West - Frozen Heart", 177,
                 lambda state, player: state.has("Progressive Knuckle", player, 2) and
                 (state.has("Lariat", player) or state.prodigal_has_cleats(player) or state.prodigal_skips(player)) and
                 state.has("Progressive Pick", player) and state.prodigal_has_key("Crystal Caves", player, 3)),
    ...
    LocationData("Pirate's Pier", "Pirate's Pier - Upstairs - Block Push Chest", 126,
                 lambda state, player: state.has("Progressive Pick", player) and
                 state.has("Lariat", player) and
                 (state.prodigal_skips(player) or state.has("Progressive Knuckle", player, 2))),
    LocationData("Pirate's Pier", "Pirate's Pier - Upstairs - Barrel Switches Chest", 129,
                 lambda state, player: state.has("Progressive Pick", player) and
                 state.has("Lariat", player) and (state.has("Progressive Hand", player, 2) or
                 (state.prodigal_skips(player) and state.has("Progressive Hand", player))) and
                 state.prodigal_has_key("Pirate's Pier", player, 5)),
